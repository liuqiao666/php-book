...
<img src="Images/bg.gif"/> <a href="messagelogin.php">管理员登陆</a>
  <div class="1" style="position:absolute; z-index:2; left:15px; top:1px; margin-left:90px; margin-top:100px;">
    ...
    <label>
      <p><input type="submit" name="dl" id="dl" value="登 录"  style="margin-left:170px"/>
        <input type="submit" name="zc" id="zc" value="注 册" style="margin-left:45px" />
      </p>
    </label>
    </div>
  </div>
		...
		if($hang==0)
		  echo "<script>alert('用户名或密码错误');</script>";
		else
			{
				  ...
				  echo "<script> location.href='readerlook.php';</script>"; 
			}
	}
	else
	{
